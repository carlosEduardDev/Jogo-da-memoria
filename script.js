...
class ImagesEvents {
    ...
    setClass(e) {
        if (e.currentTarget instanceof HTMLElement) {
            ...
            if (this.firstCard === "") {
                ...
                setTimeout(() => {
                    if (this.firstCard instanceof HTMLDivElement &&
                        this.secondCard instanceof HTMLDivElement) {
                        if (this.firstCard.style.backgroundImage ===
                            ...
                            this.images.forEach((item) => item.addEventListener("click", this.setClass));
    ...
    resetGame() {
        if (this.current === 128) {
            ...
            this.game.innerHTML = "";
            this.current = 0;
            if (resetGame instanceof HTMLElement)
